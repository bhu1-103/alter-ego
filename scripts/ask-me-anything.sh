...
prompt=$(tac $logs_dir/prompts.txt | awk -F "Prompt: " '{print $2}' | uniq | rofi -dmenu -theme $HOME/.config/rofi/launchers/type-7/style-3 -p "Jarvis with $model here" -p "ENTER PROMPT")
